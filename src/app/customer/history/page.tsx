...
export default async function CustomerHistoryPage() {
  ...
  return (
    <div>
      <h1 className="mb-4 font-heading text-xl font-bold text-foreground">Service History</h1>
      <Card>
        <CardContent className="divide-y divide-surface-2 p-0">
          ...
          {(!requests || requests.length === 0) && (
            <p className="p-5 text-center text-sm text-muted-foreground">No service requests yet.</p>
          )}
        </CardContent>
      </Card>
    </div>
